...
int main()
{
	...
	do
	{
		...
		case 3: inorder(tobj.root);
				break;
		case 4: preorder(tobj.root);
				break;
		case 5: postorder(tobj.root);
				break;
		case 6: printf("enter the element to be deleted\n");
				...
				break;
		case 7: printf("enter the info to be searched\n");
				scanf("%d", &ele);
			...
			*/
				if(rsearch(tobj.root,ele))
					...
					printf("%d not found\n",ele);
				break;
		case 8: if(tobj.root==NULL)
					printf("Tree is empty\n");
				else	
					printf("Minimum element = %d\n", min(tobj.root));
				break;
		case 9: if(tobj.root==NULL)
					printf("Tree is empty\n");
				else
					printf("Maximum element = %d\n", max(tobj.root));
				break;
		case 10:printf("Tree height=%d",height(tobj.root));
				break;
		case 11:printf("Tree Depth=%d",height(tobj.root));
				break;
		case 12: break;
		}
	}while(choice<12);
